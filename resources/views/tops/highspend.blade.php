        ...
        <table style="border: 1px solid black; font-size: 10px; margin-top: 22px;">
            <thead style="background-color:#c8c8c8; padding: 5px; font-size: 9px;">
                <tr>    
                    ...
                    <th style="vertical-align: middle;" width="15%">Total</th>
                </tr>
            </thead>
            <tbody>
                @foreach($lists as $dtr)  <!-- 🔥 THIS IS THE FIX -->
                    <tr>
                        ...
                        <td style="text-align:center;">
                            ...
                            <span style="position: absolute; top: 4.7px; left: 1; width: .68em; border-top: .65px solid #000000"></span>
                            <span style="position: absolute; top: 3.7px; left: 1; width: .68em; border-top: .65px solid #000000"></span>
                                P{{ number_format($dtr['total'], 2) }}
                            </span>
                           </td>
                    </tr>
                @endforeach

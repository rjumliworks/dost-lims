...
$form = $configuration['form'] = $configuration['form'];
    ...
    <body>
        ...
        <center style="font-size: 12px; background-color: #000; color:#fff; font-weight: bold; padding: 3px; margin-top: 15px;">ELECTRONIC OFFICIAL RECEIPT</center>
        <table style="border: 1px solid black; font-size: 11px; margin-top: 25px;">
            <tbody>
                <tr>
                    <td width="50%">eOR No.: </td>
                    <td width="50%">
                    <span>KJH123GJHSAKHJ</span>
                    </td>
                    <td width="50%">Reference No.:</td>
                    <td width="50%"><span>{{$tsr['code']}}</span></td>
                </tr>
                <tr>
        ...
        <table style="border: 1px solid black; font-size: 11px; margin-top: 25px;">
            <tbody>
                <tr>
                    <td width="25%">Name of Payor</td>
                    <td width="75%"><span style="font-weight: bold;">{{$tsr['customer']['fullname']}}</span></td>
                </tr>    
                <tr>
                    <td width="25%">Address</td>
                    <td width="75%">{{$tsr['customer']['fulladdress']}}</td>
                </tr>
        ...
        <table style="border: 1px solid black; font-size: 10px; margin-top: 25px;">
            <thead style="background-color:#c8c8c8; font-size: 9px;">
                <tr>    
                    <th width="70%" style="text-align: left;">PARTICULARS</th>
            ...
            <tbody style="height: 400px;">
                <tr>
                    <td>{{$tsr['code']}}</td>
                    <td style="text-align: center;">{{$tsr['onlinepayment']['subtotal']}}</td>
                </tr>
                <tr>
                    <td>Service Fee</td>
                    <td style="text-align: center;">{{$tsr['onlinepayment']['fee']}}</td>
                </tr>
            </tbody>
            <tfoot style="text-align: center; font-weight: bold; background-color:#c8c8c8; font-size: 11px;">
                <tr>
                    <td style="font-size: 11px;">TOTAL</td>
                    <td style="font-size: 11px;"><span style="font-family: DejaVu Sans;">&#8369;</span>{{trim($tsr['payment']['total'],'₱ ')}}</td>
                </tr>
            </tfoot>
        </table>

<template>
    ...
    <b-row class="g-3">
        ...
        <div class="col-md-3">
            <b-row class="g-3">
                <div class="col-md-12">
                    <b-card no-body class="border bg-success-subtle shadow-none" style="cursor: pointer;" @click="openCreate()">
                        <b-card-body>
                            <div class="d-flex mb-n3">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="mb-0 fs-14"><span class="text-body">Today's Collection</span></h5>
                                    <p class="text-muted text-truncate-two-lines fs-12">Today's Collection</p>
                                </div>
                            </div>
                        </b-card-body>
                    </b-card>
                                ...
                                <div class="p-1 border bg-light border-dashed rounded">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <h5 class="mb-0 fs-12">May 18, 2026 5:37 pm</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>

                             <b-list-group flush class="mt-1"  style="height: 300px; overflow: auto;" v-if="dropdowns.tsrs.data.length > 0">

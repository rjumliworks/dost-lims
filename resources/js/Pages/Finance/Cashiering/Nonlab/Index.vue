                        ...
                        <div class="flex-shrink-0 me-3">
                            <div style="height:2.5rem;width:2.5rem;">
                                <span class="avatar-title bg-primary-subtle rounded p-2 mt-n1">
                                    <i class="ri-price-tag-2-line text-primary fs-24"></i>
                                </span>
                            </div>
                        </div>
                        <div class="flex-grow-1">
                            <h5 class="mb-0 fs-14"><span class="text-body">Non-Laboratory Receipt Records</span></h5>
                            <p class="text-muted text-truncate-two-lines fs-12">Manage and view receipts for transactions not related to laboratory services.</p>
                        </div>
                        ...
                        <table class="table table-nowrap align-middle mb-0">
                            <thead class="table-light">
                                <tr class="fs-11">
                                    <th style="width: 3%;"></th>
                                    <th>Customer</th>
                                    <th style="width: 12%;" class="text-center">Collection</th>
...
export default {
    ...
    methods: {
        ...
        fetch(page_url){
            page_url = page_url || '/nonlabreceipts';
            axios.get(page_url,{
                params : {

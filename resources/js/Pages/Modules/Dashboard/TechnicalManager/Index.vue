            ...
            <div class="card bg-light-subtle shadow-none border">
                ...
                <div class="card-header p-0 border-0 bg-light-subtle">
                    <div class="row g-0 text-center">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="p-3 border border-dashed border-start-0">
                                <h5 class="mb-1 fs-12">{{equipments.maintenance}}</h5>
                                <p class="text-muted mb-0 fs-12">Maintenance</p>
                            </div>
                        </div>
                        <div class="col-6 col-sm-6">
                            <div class="p-3 border border-dashed border-start-0">
                                <h5 class="mb-1 fs-12">{{equipments.calibration}}</h5>
                                <p class="text-muted mb-0 fs-12">Calibration</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="list-group list-group-flush border-dashed mt-n2">
                            <li class="list-group-item ps-0" v-for="(list,index) in equipments.list" v-bind:key="index">
                                <div class="row align-items-center g-3">
                                    <div class="col-auto">
                                        <div class="avatar-xs">
                                            <span class="avatar-title rounded-circle" :class="list.bg">
                                                <i :class="list.icon" class="fs-18"></i>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col">
            ...
            <div class="card bg-light-subtle shadow-none border">
                ...
                <div class="card-header p-0 border-0 bg-light-subtle">
                    <div class="row g-0 text-center">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="p-3 border border-dashed border-start-0">
                                <h5 class="mb-1 fs-12">{{inventory.outofstock}}</h5>
                                <p class="text-muted mb-0 fs-12">Out of Stock</p>
                            </div>
                        </div>
                        <div class="col-6 col-sm-6">
                            <div class="p-3 border border-dashed border-start-0">
                                <h5 class="mb-1 fs-12">{{inventory.expired}}</h5>

                        ...
                        <div class="col-md-12 margin-space">
                            <div class="d-flex mt-3">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <h6 class="text-truncate mb-0 fs-12">
                                        <span >{{selected.discount}} <span class="text-muted">({{selected.discounted.name}} - {{selected.discounted.value }}%)</span></span>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="d-flex mt-3">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <h6 class="text-truncate mb-0 fs-12">{{selected.total}}</h6>
                                </div>
                            </div>
                        </div>
                    </div>

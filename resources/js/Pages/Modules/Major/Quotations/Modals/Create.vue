<template>
    <b-modal v-model="showModal" style="--vz-modal-width: 700px;" header-class="p-3 bg-light" :title="(!editable) ? 'Create Quotation' : 'Edit Quotation'" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>
        <BRow>

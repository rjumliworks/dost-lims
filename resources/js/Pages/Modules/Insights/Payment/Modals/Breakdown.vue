<template>
    <b-modal v-model="showModal" style="--vz-modal-width: 1000px;" hide-footer header-class="p-3 bg-light" title="View Breakdown" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>
        <BRow>
            <div class="col-md-12">
...
export default {
    ...
    computed: {
        ...
        totalAmount(){
            return this.listsWithPercentage.reduce((sum, list) => sum + Number(list.amount || 0), 0);
        },
        totalPercentage(){

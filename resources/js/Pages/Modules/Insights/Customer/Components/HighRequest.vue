<template>
    ...
    <HighRequest :dropdowns="dropdowns" ref="highrequest"/>
</template>
<script>
import _ from 'lodash';
import simplebar from "simplebar-vue";
import HighRequest from '../Modals/HighRequest.vue';
export default {
    props: ['total','lists','dropdowns'],
    components: { simplebar, HighRequest },
    data(){
        return {
            sort: null,
        }

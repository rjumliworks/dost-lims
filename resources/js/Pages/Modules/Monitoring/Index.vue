                        ...
                        <div class="col-12">
                            <div class="d-flex flex-lg-row flex-column">
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted mb-0">Here's what's happening with the laboratory <span v-if="monthName">for month of {{monthName}}</span></p>
                                </div>
        ...
        <div class="col-md-12 mt-n2" style="height: calc(100vh - 310px); overflow-y: auto; overflow-x: hidden;">
            <div class="row g-3">
                ...
                <div class="col-md-3">
                        ...
                        <b-card-body>
                            <div class="d-flex align-items-center" v-if="laboratories.length > 0">
                                <div class="flex-shrink-0">
                                    <div class="donut-chart mx-auto" :style="{background: `conic-gradient(#0ab39c ${overallPercentage}%, #e9ebec 0)`}">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <p class="text-uppercase text-truncate fw-semibold fs-10 text-muted mb-1" style="margin-top: -5px;">Laboratory Progress</p>
                                    <h4 class="mb-0 fs-12">{{ totalOngoing }} / {{ totalOverall }}</h4>
                                    <small class="text-muted fs-10">Ongoing TSR across all laboratories</small>
                                </div>
                            </div>
                        </b-card-body>
                    </b-card>
                    ...
                    <template v-else>
                        <b-col lg="12">
                            <b-card no-body class="border shadow-none bg-info-subtle">
                                <b-card-body>
                   ...
                   <div class="card shadow-none border mt-n1">
                        ...
                        <div class="shadow-none" no-body style="height: 380px; overflow: auto;">
                            ...
                            <ul class="list-group list-group-flush border-dashed mt-n4 p-3 mt-n2">
                                <li class="list-group-item px-0" v-for="(list,index) in alerts" v-bind:key="index" @click="openReminder(list.type)" style="cursor: pointer;">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 avatar-xs">
                                            <span class="avatar-title bg-light p-1 rounded-circle fs-17">
                                                <i :class="list.icon+' '+list.color"></i>
                    ...
                    <div class="card shadow-none border mt-n1">
                        <div class="card-header bg-light-subtle">
                            <div class="d-flex mb-n3">
                                ...
                                <div class="flex-grow-1">
                                    <h5 v-if="filter.reminder" class="mb-0 mt-0 fs-13"><span class="text-body">{{ filter.reminder }} - Technical Service Requests</span></h5>
                                    <h5 v-else class="mb-0 mt-0 fs-13"><span class="text-body">Ongoing Technical Service Requests</span></h5>
                                    <p class="text-muted text-truncate-two-lines fs-11">Highlights urgency and updates</p>
                                </div>
                            </div>
                        </div>
                        <div class="shadow-none" no-body>
                            <div class="border-bottom shadow-none">
                            ...
                            <div class="card-body">
                                <div class="table-responsive table-card" style="height: 263px; overflow: auto;">
                                    <table class="table align-middle table-centered table-bordered table-striped mb-0">
                                        ...
                                        <tbody>
                                            <tr class="ribbon-box" v-for="(list,index) in lists" v-bind:key="index" :class="{ 'bg-danger-subtle': isPastDue(list.due_at) }">
                                                <td>
                   ...
                   <div class="card shadow-none border mt-n1">
                        <div class="card-header bg-light-subtle">
                            <div class="d-flex mb-n3">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="mb-0 mt-0 fs-13"><span class="text-body">Laboratory Monitoring</span></h5>
                                    <p class="text-muted text-truncate-two-lines fs-11">Ongoing TSR by laboratory</p>
                                </div>
                            </div>
                        </div>
                        <div class="shadow-none" no-body style="height: 380px; overflow: auto;">
                           <ul class="list-group list-group-flush border-dashed mb-n4 mt-n2 p-3">
                                <li class="list-group-item px-0 mb-0" v-for="(list,index) in laboratories" v-bind:key="index">
                                        ...
                                        <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="mt-auto">
                                                <!-- <div class="d-flex mb-1">
                                                    <div class="flex-grow-1">
                                                        <p class="fs-11 mb-0 text-muted">..</p>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                                        <div class="fs-12">
                                                            <i class="ri-list-check align-bottom me-1 text-muted"></i>
                                                            {{ list.ongoing }}/{{ list.overall }} <span class="text-muted">({{ list.percentage }}%)</span>
                                                        </div>
                                                    </div>
                                                </div> -->
                                                <div class="d-flex mb-1">
                                                    <div class="flex-grow-1 text-muted fs-12 mt-1">
                                                         <i class="ri-list-check align-bottom me-1 text-muted"></i>
                                                            <span class="text-danger">{{ list.ongoing }}</span> ongoing out of <span class="text-success">{{ list.overall }}</span> tsrs requested <span class="text-muted">({{ list.percentage }}%)</span>
                                                    </div>
                ...
                <div class="col-md-3">
                    <div class="card shadow-none border mt-n4">
                        <div class="card-header bg-light-subtle">
                            <div class="d-flex mb-n3">
                                <div class="flex-shrink-0 me-3 mt-1">
                                    <div style="height:2rem;width:2rem;">
    ...
    data(){
        return {
            ...
            filter: {
                ...
                laboratory: null,
                reminder: null,
                month: null, //new Date().toLocaleString('default', { month: 'long' })

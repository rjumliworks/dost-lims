                                        ...
                                        <div class="carousel-content">
                                            <transition mode="out-in">
                                                <div :key="index" class="tab-content">
                                                    <StockIn :item="item.data" :dropdowns="dropdowns" v-if="menu.key == 'stockin'" ref="stockin"/>
                                                    <StockOut :id="item.data.id" v-if="menu.key == 'stockout'"/>
                                                </div>
                                            </transition>
                                        </div>
                                    </div>
...
export default {
    ...
    components: { PageHeader, Top, Sidebar, StockIn, StockOut },
    data(){
        return {
            menus: [
                { label: 'Stock In', key: 'stockin' },
                { label: 'Stock Out', key: 'stockout' }
            ],
            type: 'stockin',
            index: null,
        }

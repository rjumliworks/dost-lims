<template>
    <Head title="Testservices by Region"/>
    <PageHeader title="Testservice Overview" pageTitle="Testservices by Region" />
    <BRow>
        <div class="col-md-12">
                ...
                <div class="card-header bg-light-subtle">
                    <div class="d-flex mb-n3">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="mb-0 fs-14"><span class="text-body">List of Testservices</span></h5>
                            <p class="text-muted text-truncate-two-lines fs-12">Monitor test services offered across all agencies, filterable by region.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <b-row class="mb-2 ms-1 me-1" style="margin-top: 12px;">
                        <b-col lg>
                            <div class="input-group mb-1">
                                ...
                                <input type="text" v-model="filter.keyword" placeholder="Search Testservice" class="form-control" style="width: 25%;">
                        ...
                        <table class="table align-middle table-centered table-striped mb-0">
                            ...
                            <tbody class="table-white fs-12" v-if="lists.length > 0">
                                <tr v-for="(list,index) in lists" v-bind:key="list.id">
                                    ...
                                    <td class="fw-semibold">{{ list.testname?.name || '-' }}</td>
                            ...
                            <tbody v-else>
                                <tr>
                                    <td colspan="7" class="text-center text-muted">No testservices found.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
export default {
    ...
    methods: {
        ...
        fetch(page_url){
            page_url = page_url || '/testservices-overview';
            axios.get(page_url,{
                params : {
                    option: 'list',

<template>
    <b-modal v-model="showModal" style="--vz-modal-width: 600px;" header-class="p-3 bg-light" title="Folder Details" hide-footer class="v-modal-custom"
                    ...
                    <div class="p-1 border border-dashed rounded">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <p class="text-muted mb-0 fs-12">Folder name :</p>
                ...
                <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                    <div class="d-flex mt-3">
                        ...
                        <div class="flex-grow-1 overflow-hidden">
                            <p class="mb-1 fs-12 text-muted">Files :</p>
                            <h6 class="text-truncate mb-0 fs-12">{{ selected.count }}</h6>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="d-flex mt-3">
                        ...
                        <div class="flex-grow-1 overflow-hidden">
                            ...
                            <h6 class="text-truncate mb-0 fs-12">{{ selected.type?.name }}
                            </h6>
                        </div>
                    </div>
                </div>

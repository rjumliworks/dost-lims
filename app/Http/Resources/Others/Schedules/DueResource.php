...
class DueResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'className' => $color,
            'type' => ($this->customer->customer_name->has_branches) ? ($this->is_main) ? $this->customer->customer_name->name :  $this->customer->customer_name->name.' - '.$this->customer->name : $this->customer->customer_name->name,
